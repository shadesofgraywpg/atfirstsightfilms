...
function stag_custom_post_colors_output($content){
  ...
  foreach($posts as $post){
    ...
    if( !empty($bg) && !empty($text) && !empty($link) ):
      $output .= "\n\n#post-$postid{";
      if($bg !== '' && !empty($bg)) $output .= "background-color: {$bg};";
    ...
    if($bg != "" ){
      ...
      $output .= ".postid-".$postid." a{ color: ". $bg ."; }\n";
      $output .= ".postid-".$postid." blockquote p{ border-color: ". $bg ."; }\n";
      $output .= ".postid-".$postid." .hentry a{ color: ". $text ."; }\n";
      $output .= ".postid-".$postid." .entry-content a{ border-bottom: 1px solid ". $text ."; }\n";
